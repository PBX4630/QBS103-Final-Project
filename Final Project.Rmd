...
header-includes:
  ...
  - \usepackage{array}
  - \usepackage{float}
Githublink: https://github.com/PBX4630/QBS103-Final-Project/tree/main
---
Step0:Environment
...
I analyzed a patient data set containing both clinical variables and gene expression data. 
...
All analyses were processed in \textbf{R version 4.3.1}. 
...
I also applied hierarchical clustering to both rows and columns, using Euclidean distance as the distance metric and complete linkage as the clustering method.
In order to reduce visual complexity, I restrict the heatmap to the first 20 patients as an illustrative example.

For the final step, I introduced an additional plot type, the \texttt{hexbin} plot, to explore the joint distribution of CRP and ferritin values. This method bins data into hexagonal cells and encodes cell counts with color intensity, allowing dense two dimensional relationships to be visualized.
